...
const ExploreMenu = ({Category, setCategory}) => {
  return (
    <div id='explore-menu' className='explore-menu flex flex-col gap-[20px] my-16'>
        ...
        <p className='explore-menu-text w-[66%]'> Choose from a diverse menu featuring a delecated array of Products crafted with the finest ingredients and culinary expertise. Our mission is to satisfy your diet goals elevate you experience, one delecious meal at a time.</p>
        <div className="explore-menu-list scroll-content my-[20px] flex gap-[60px] items-center justify-center text-center">
            {
